<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="drink.aspx.cs" Inherits="foody.drink" %>
            ...
            <div class="card">
               <div class="card-body ">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img width="100px" src="imgs/drink.png" />
                 ...
                 <hr />
                  <div class="row">
                                           ...
                                           <div class="col-6 mx-auto">                                                 <asp:Button ID="Button4" class="btn btn-lg btn-block btn-warning" runat="server" Text="Update" OnClick="Button4_Click1"   />
</div>
